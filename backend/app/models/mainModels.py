...
class Users(AbstractBaseUser, models.Model):
    ...
    user_married = models.BooleanField(blank=True, null=True)
    user_multiple_incomes = models.BooleanField(blank=True, null=True)
    user_children = models.BooleanField(blank=True, null=True)
    user_city = models.BooleanField(blank=True, null=True)
