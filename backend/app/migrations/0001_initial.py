# Generated by Django 3.2.7 on 2022-01-30 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_title', models.CharField(db_column='experience__title', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.experience')),
            ],
            options={
                'db_table': 'item',
                'managed': True,
        ...
        migrations.AddField(
            model_name='users',
            name='experience',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.experience'),
        ),
        migrations.AddField(
            model_name='users',
